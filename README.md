...
A local-first, end-to-end web interface for running LLM benchmarks via the EleutherAI `lm-eval` harness. Built as a Proof of Concept for the AI eval project.
